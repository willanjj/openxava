...
abstract public class NaviOXTestBase extends ModuleTestBase {
	...
	protected String getModuleURL() throws XavaException { 
		...
		return "http://" + getHost() + ":" + getPort() + getContextPath() + moduleURL; 
	}
	...
	protected void loginFailing(String user, String password) throws Exception {
		loginFailing(user, password, "Unauthorized user");
	}

	/** @since 6.2 */
	protected void loginFailing(String user, String password, String message) throws Exception {
